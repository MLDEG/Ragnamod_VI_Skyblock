events.listen('recipes', function (e) {
  ...
  e.smelting('kubejs:platinum_ingot', 'ragnamod_6_sky:chunk_platinum')
  e.blasting('kubejs:platinum_ingot', 'ragnamod_6_sky:chunk_platinum')
  //Tungsten
  ...
  //Wooden Crucible
  e.shaped(item.of('exnihilosequentia:crucible_wood', 1), ['A A', 'ABA', 'C C'], {
    A: '#minecraft:logs',
    B: '#minecraft:wooden_slabs',
    C: '#forge:rods/wooden'
  })
  //Wooden Barrel
  e.shaped(item.of('exnihilosequentia:barrel_wood', 1), ['A A', 'A A', 'ABA'], {
    A: '#minecraft:planks',
    B: '#minecraft:wooden_slabs'
  })
  //Sieve
  e.shaped(item.of('exnihilosequentia:sieve', 1), ['A A', 'ABA', 'C C'], {
    A: '#minecraft:planks',
    B: '#minecraft:wooden_slabs',
    C: '#forge:rods/wooden'
  })
  ...
  function craftpiece(pieceOre) {
    e.shapeless('ragnamod_6_sky:chunk_' + pieceOre, '4x ragnamod_6_sky:piece_' + pieceOre)
    e.shapeless('4x ragnamod_6_sky:piece_' + pieceOre, 'ragnamod_6_sky:chunk_' + pieceOre)
  }
  var ore = ['iron', 'gold', 'aluminum', 'uranium', 'zinc', 'tungsten', 'osmium', 'copper', 'tin', 'lead', 'silver', 'nickel', 'cobalt', 'pendorite', 'emeraldite', 'amber', 'ender', 'endumium', 'soulium', 'platinum', 'source_gem']
  ore.forEach(O => { craftpiece(O) })

  //Gabbro
  e.shapeless('create:gabbro_cobblestone', '4x ragnamod_6_sky:gabbro_pebble')

  //Granite
  e.shapeless('create:granite_cobblestone', '4x ragnamod_6_sky:granite_pebble')

  //Diorite
  e.shapeless('create:diorite_cobblestone', '4x ragnamod_6_sky:diorite_pebble')

  //Andesite
  e.shapeless('create:andesite_cobblestone', '4x ragnamod_6_sky:andesite_pebble')

  //Cobble
  e.shapeless('minecraft:cobblestone', '4x ragnamod_6_sky:cobble_pebble')

  //Deepslate
  e.shapeless('quark:cobbled_deepslate', '4x ragnamod_6_sky:deepslate_pebble')

  //Cobble
  e.shapeless('minecraft:blackstone', '4x ragnamod_6_sky:blackstone_pebble')

  //Basalt
  e.shapeless('minecraft:basalt', '4x ragnamod_6_sky:basalt_pebble')

  //Basalt
  e.shapeless('minecraft:oak_sapling', '4x botania:living_root')

  //Warped Nylium
  e.custom({
    "type": "interactio:item_fluid_transform",
    "inputs": [{ "item": "minecraft:warped_wart_block", "count": 1 }, { "item": "minecraft:netherrack", "count": 1 }],
    "fluid": { "fluid": "tconstruct:liquid_soul" },
    "output": { "entries": [{ "result": { "item": "minecraft:warped_nylium", "count": 2 }, "weight": 1 }], "rolls": 1 },
    "consume_fluid": 1.0
  })
  //Crimson Nylium
  e.custom({
    "type": "interactio:item_fluid_transform",
    "inputs": [{ "item": "minecraft:nether_wart_block", "count": 1 }, { "item": "minecraft:netherrack", "count": 1 }],
    "fluid": { "fluid": "tconstruct:liquid_soul" },
    "output": { "entries": [{ "result": { "item": "minecraft:crimson_nylium", "count": 2 }, "weight": 1 }], "rolls": 1 },
    "consume_fluid": 1.0
  })
  //Menril Sapling
  e.custom({
    "type": "interactio:item_fluid_transform",
    "inputs": [{ "item": "minecraft:oak_sapling", "count": 1 }],
    "fluid": { "fluid": "tconstruct:molten_cobalt" },
    "output": { "entries": [{ "result": { "item": "integrateddynamics:menril_sapling", "count": 1 }, "weight": 1 }], "rolls": 1 },
    "consume_fluid": 1.0
  })
  //Bee
  function spawnEggBee(input, output) { e.custom({ "type": "interactio:item_fluid_transform", "inputs": [{ "item": "mob_grinding_utils:golden_egg", "count": 1 }, { "item": input, "count": 1 }], "fluid": { "fluid": "resourcefulbees:honey" }, "output": { "entries": [{ "result": { "item": "resourcefulbees:" + output + "_bee_spawn_egg", "count": 1 }, "weight": 1 }], "rolls": 1 }, "consume_fluid": 1.0 }) }

  spawnEggBee('compressium:sand_1', 'sandy')
  spawnEggBee('minecraft:lava_bucket', 'lava')
  spawnEggBee('minecraft:bone_block', 'skeleton')
  spawnEggBee('compressium:endstone_1', 'end')
  spawnEggBee('minecraft:prismarine_crystals', 'guardian')
  spawnEggBee('minecraft:slime_block', 'slimy')
  spawnEggBee('architects_palette:rotten_flesh_block', 'zombie')
  spawnEggBee('architects_palette:ender_pearl_block', 'ender')
  spawnEggBee('minecraft:blue_ice', 'icy')
  spawnEggBee('minecraft:oak_log', 'woody')
  spawnEggBee('minecraft:glowstone', 'pigman')
  spawnEggBee('botania:cosmetic_cat_ears', 'kitten')
  spawnEggBee('compressium:cobblestone_1', 'rock')
  spawnEggBee('compressium:gravel_1', 'gravel')
  spawnEggBee('compressium:clay_1', 'clay')
  spawnEggBee('compressium:netherrack_1', 'nether')
  spawnEggBee('compressium:dirt_1', 'dirty')
  spawnEggBee('earthmobsmod:rainbow_wool', 'rgbee')
  spawnEggBee('minecraft:cake', 'oreo')
  spawnEggBee('extendedcrafting:nether_star_block', 'starry')
  spawnEggBee('neapolitan:strawberry_milkshake', 'abbee')
})