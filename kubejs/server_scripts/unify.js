...
events.listen('recipes', function (e) {
    ...
    function unify() {
        ...
        e.blasting('thermal:nickel_ingot', '#forge:ores/nickel').xp(0.1)
        e.smelting('thermal:nickel_ingot', '#forge:ores/nickel').xp(0.1)
        e.blasting('kubejs:platinum_ingot', 'create:crushed_platinum_ore').xp(0.1)
        e.smelting('kubejs:platinum_ingot', 'create:crushed_platinum_ore').xp(0.1)
    ...
    function nugget() {
        ...
        e.custom({ "type": "create:splashing", "ingredients": [{ "item": "create:crushed_platinum_ore" }], "results": [{ "item": "kubejs:platinum_nugget", "count": 10 }, { "item": "kubejs:platinum_nugget", "count": 5, "chance": 0.5 }] })
    }
    function dense() {
